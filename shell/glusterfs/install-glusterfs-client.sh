...
fn::install_glusterfs_server()
{
  ...
  # Dependencies: glusterfs glusterfs-client-xlators glusterfs-libs
  fn::install_package epel-release centos-release-gluster${repo_ver} glusterfs-fuse-${version} glusterfs-rdma-${version}
}
